...
final class NewsCategoryController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(NewsCategoryForm::class, $newsCategory);
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$newsCategory->getId(), $request->getPayload()->getString('_token'))) {
